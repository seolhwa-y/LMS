...
<script type="text/javascript">
	...
	function returnPurchaseList(currentPage) {
		...
		callAjax("/pur/refundFinalProcessingList.do", "post", "text", true, param, resultCallBack );
	} 	
	//전체 주문내역 페이징 처리
	function rplr(data, currentPage) {
			//console.log("data" + data);

		$("#refundFinalProcessingList").empty().append(data);
	...
	function ModalStart(RE_CODE){
		...
		callAjax("refundFinalProcessOne.do", "post", "json", true, param, resultCallback2);
	}
	
	//주문내역 검색	`			refund ----> Order
	function searchreturnOrderList(currentPage) {
			...
			callAjax("/pur/refundFincalProcessingList.do", "post", "text", true, param, resultCallBackSearch);
		}
