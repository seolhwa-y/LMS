...
<script type="text/javascript">
   ...
   function fListInfResult(data, currentPage) {
    ...
    function fn_noticeSave(){
       noticeareavar.action == "I" ? alert("I") : alert("U");
       
       var param = {
    		   action : noticeareavar.action,
    		   nottitle : noticeeditvue.noticeTitle,
    		   noticeContent : noticeeditvue.noticeContent,
    		   notcode : noticeeditvue.noticeNo
       }
    ...
    /* 게시글 삭제 */
    function fn_noticeDel(){
    	var param = {
     		   notcode : noticeeditvue.noticeNo
        }
        
        var delCallBack = function(delReturn){
     	   console.log(delReturn);
     	   
     	   delReturn.result == "SUCCESS" ? alert(delReturn.resultMsg) : alert("실패");
     	   
     	   fListInf();
     	   gfCloseModal();
    	}
        
        callAjax("/system/noticeDelete.do", "post", "json", true, param, delCallBack);
    }
    ...
    function frealPopModal(object){
       if(noticeareavar.action == "I") {
           ...
           noticeeditvue.delflag = false; // v-show :: false 경우 보인다.
       } else {
           ...
           noticeeditvue.delflag = true; // v-show :: true 경우 안보인다.
       }
       ...
       $("#noticeNo").val(noticeeditvue.noticeNo); // 중요한 num 값도 숨겨서 받아온다. 
    }
                  ...
                  <br>
                     ...
                     <p class="conTitle" style="margin-bottom: 1%;">
                        ...
                        <p class="conTitle">
                           <span>공지사항</span> 
                           		<span class="fr"> 
                           			<a class="btnType blue" href="javascript:fn_noticereg();" name="modal"><span>신규등록</span></a>
                          		</span>
                         </p>    
