...
public class RefundFinalProcessingModel {
	...
	public String toString() {
		return "RefundFinalProcessingModel [RE_CODE=" + RE_CODE + ", loginID=" + loginID + ", PD_NAME=" + PD_NAME
				+ ", RE_AMT=" + RE_AMT + ", RE_DATE=" + RE_DATE + ", RE_TYPE=" + RE_TYPE + ", sdate=" + sdate
				+ ", edate=" + edate + ", cpname=" + cpname + ", pdname=" + pdname + ", approved=" + approved
				+ ", unapproved=" + unapproved + ", currentPage=" + currentPage + ", pageSize=" + pageSize
				+ ", pageIndex=" + pageIndex + "]";
	}
